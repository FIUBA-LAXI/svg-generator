...
(defn generate-svg [lineas extremos grosor color]
...
(defn write-svg-file [file-path lineas extremos grosor color]
  (let [svg-content (generate-svg lineas extremos grosor color)]
